...
var iPLAYER_COLORS=0;
const THEMES = ['#c9af98', '#2F4F4F', '#6B7A8F', '#00303F', 'rgb(3, 74, 166)', '#458766', '#7A9D96'];
var iTHEME = 0;
function nextPlayerColor(){iPLAYER_COLORS=(iPLAYER_COLORS+1)%PLAYER_COLORS.length;return PLAYER_COLORS[iPLAYER_COLORS];}
function nextTheme(){iTHEME=(iTHEME+1)%THEMES.length;return THEMES[iTHEME];}
function nextPlayerColor(){iCOLORS=(iCOLOR+1)%COLORS;return COLORS[iCOLOR];}
